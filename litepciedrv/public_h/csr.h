//--------------------------------------------------------------------------------
// Auto-generated by LiteX (f63d4a833) on 2024-12-19 15:55:02
//--------------------------------------------------------------------------------
...
/* ADC Registers */
#define CSR_ADC_BASE (CSR_BASE + 0x6000L)
#define CSR_ADC_CONTROL_ADDR (CSR_BASE + 0x6000L)
#define CSR_ADC_CONTROL_SIZE 1
#define CSR_ADC_TRIGGER_CONTROL_ADDR (CSR_BASE + 0x6004L)
#define CSR_ADC_TRIGGER_CONTROL_SIZE 1
#define CSR_ADC_HAD1511_CONTROL_ADDR (CSR_BASE + 0x6008L)
#define CSR_ADC_HAD1511_CONTROL_SIZE 1
#define CSR_ADC_HAD1511_STATUS_ADDR (CSR_BASE + 0x600cL)
#define CSR_ADC_HAD1511_STATUS_SIZE 1
#define CSR_ADC_HAD1511_DOWNSAMPLING_ADDR (CSR_BASE + 0x6010L)
#define CSR_ADC_HAD1511_DOWNSAMPLING_SIZE 1
#define CSR_ADC_HAD1511_RANGE_ADDR (CSR_BASE + 0x6014L)
#define CSR_ADC_HAD1511_RANGE_SIZE 1
#define CSR_ADC_HAD1511_BITSLIP_COUNT_ADDR (CSR_BASE + 0x6018L)
#define CSR_ADC_HAD1511_BITSLIP_COUNT_SIZE 1
#define CSR_ADC_HAD1511_SAMPLE_COUNT_ADDR (CSR_BASE + 0x601cL)
#define CSR_ADC_HAD1511_SAMPLE_COUNT_SIZE 1
#define CSR_ADC_HAD1511_DATA_CHANNELS_ADDR (CSR_BASE + 0x6020L)
#define CSR_ADC_HAD1511_DATA_CHANNELS_SIZE 1
...
#define CSR_ADC_HAD1511_DATA_CHANNELS_SHUFFLE_OFFSET 0
#define CSR_ADC_HAD1511_DATA_CHANNELS_SHUFFLE_SIZE 2
#define CSR_ADC_HAD1511_DATA_CHANNELS_RUN_LENGTH_OFFSET 2
#define CSR_ADC_HAD1511_DATA_CHANNELS_RUN_LENGTH_SIZE 6

/* FRONTEND Registers */
#define CSR_FRONTEND_BASE (CSR_BASE + 0x6800L)
#define CSR_FRONTEND_CONTROL_ADDR (CSR_BASE + 0x6800L)
...
/* I2C Registers */
#define CSR_I2C_BASE (CSR_BASE + 0x7000L)
#define CSR_I2C_PHY_SPEED_MODE_ADDR (CSR_BASE + 0x7000L)
#define CSR_I2C_PHY_SPEED_MODE_SIZE 1
#define CSR_I2C_MASTER_ACTIVE_ADDR (CSR_BASE + 0x7004L)
#define CSR_I2C_MASTER_ACTIVE_SIZE 1
#define CSR_I2C_MASTER_SETTINGS_ADDR (CSR_BASE + 0x7008L)
#define CSR_I2C_MASTER_SETTINGS_SIZE 1
#define CSR_I2C_MASTER_ADDR_ADDR (CSR_BASE + 0x700cL)
#define CSR_I2C_MASTER_ADDR_SIZE 1
#define CSR_I2C_MASTER_RXTX_ADDR (CSR_BASE + 0x7010L)
#define CSR_I2C_MASTER_RXTX_SIZE 1
#define CSR_I2C_MASTER_STATUS_ADDR (CSR_BASE + 0x7014L)
#define CSR_I2C_MASTER_STATUS_SIZE 1

/* I2C Fields */
#define CSR_I2C_MASTER_SETTINGS_LEN_TX_OFFSET 0
#define CSR_I2C_MASTER_SETTINGS_LEN_TX_SIZE 3
#define CSR_I2C_MASTER_SETTINGS_LEN_RX_OFFSET 8
#define CSR_I2C_MASTER_SETTINGS_LEN_RX_SIZE 3
#define CSR_I2C_MASTER_SETTINGS_RECOVER_OFFSET 16
#define CSR_I2C_MASTER_SETTINGS_RECOVER_SIZE 1
#define CSR_I2C_MASTER_STATUS_TX_READY_OFFSET 0
#define CSR_I2C_MASTER_STATUS_TX_READY_SIZE 1
#define CSR_I2C_MASTER_STATUS_RX_READY_OFFSET 1
#define CSR_I2C_MASTER_STATUS_RX_READY_SIZE 1
#define CSR_I2C_MASTER_STATUS_NACK_OFFSET 8
#define CSR_I2C_MASTER_STATUS_NACK_SIZE 1
#define CSR_I2C_MASTER_STATUS_TX_UNFINISHED_OFFSET 16
#define CSR_I2C_MASTER_STATUS_TX_UNFINISHED_SIZE 1
#define CSR_I2C_MASTER_STATUS_RX_UNFINISHED_OFFSET 17
#define CSR_I2C_MASTER_STATUS_RX_UNFINISHED_SIZE 1

/* LEDS Registers */
#define CSR_LEDS_BASE (CSR_BASE + 0x7800L)
#define CSR_LEDS_OUT_ADDR (CSR_BASE + 0x7800L)
#define CSR_LEDS_OUT_SIZE 1
#define CSR_LEDS_PWM_ENABLE_ADDR (CSR_BASE + 0x7804L)
#define CSR_LEDS_PWM_ENABLE_SIZE 1
#define CSR_LEDS_PWM_WIDTH_ADDR (CSR_BASE + 0x7808L)
#define CSR_LEDS_PWM_WIDTH_SIZE 1
#define CSR_LEDS_PWM_PERIOD_ADDR (CSR_BASE + 0x780cL)
#define CSR_LEDS_PWM_PERIOD_SIZE 1

/* LEDS Fields */

/* MAIN_SPI Registers */
#define CSR_MAIN_SPI_BASE (CSR_BASE + 0x8000L)
#define CSR_MAIN_SPI_CONTROL_ADDR (CSR_BASE + 0x8000L)
#define CSR_MAIN_SPI_CONTROL_SIZE 1
#define CSR_MAIN_SPI_STATUS_ADDR (CSR_BASE + 0x8004L)
#define CSR_MAIN_SPI_STATUS_SIZE 1
#define CSR_MAIN_SPI_MOSI_ADDR (CSR_BASE + 0x8008L)
#define CSR_MAIN_SPI_MOSI_SIZE 1
#define CSR_MAIN_SPI_MISO_ADDR (CSR_BASE + 0x800cL)
#define CSR_MAIN_SPI_MISO_SIZE 1
#define CSR_MAIN_SPI_CS_ADDR (CSR_BASE + 0x8010L)
#define CSR_MAIN_SPI_CS_SIZE 1
#define CSR_MAIN_SPI_LOOPBACK_ADDR (CSR_BASE + 0x8014L)
#define CSR_MAIN_SPI_LOOPBACK_SIZE 1

/* MAIN_SPI Fields */
#define CSR_MAIN_SPI_CONTROL_START_OFFSET 0
#define CSR_MAIN_SPI_CONTROL_START_SIZE 1
#define CSR_MAIN_SPI_CONTROL_LENGTH_OFFSET 8
#define CSR_MAIN_SPI_CONTROL_LENGTH_SIZE 8
#define CSR_MAIN_SPI_STATUS_DONE_OFFSET 0
#define CSR_MAIN_SPI_STATUS_DONE_SIZE 1
#define CSR_MAIN_SPI_STATUS_MODE_OFFSET 1
#define CSR_MAIN_SPI_STATUS_MODE_SIZE 1
#define CSR_MAIN_SPI_CS_SEL_OFFSET 0
#define CSR_MAIN_SPI_CS_SEL_SIZE 5
#define CSR_MAIN_SPI_CS_MODE_OFFSET 16
#define CSR_MAIN_SPI_CS_MODE_SIZE 1
#define CSR_MAIN_SPI_LOOPBACK_MODE_OFFSET 0
#define CSR_MAIN_SPI_LOOPBACK_MODE_SIZE 1

/* PROBE_COMPENSATION Registers */
#define CSR_PROBE_COMPENSATION_BASE (CSR_BASE + 0x8800L)
#define CSR_PROBE_COMPENSATION_ENABLE_ADDR (CSR_BASE + 0x8800L)
#define CSR_PROBE_COMPENSATION_ENABLE_SIZE 1
#define CSR_PROBE_COMPENSATION_WIDTH_ADDR (CSR_BASE + 0x8804L)
#define CSR_PROBE_COMPENSATION_WIDTH_SIZE 1
#define CSR_PROBE_COMPENSATION_PERIOD_ADDR (CSR_BASE + 0x8808L)
