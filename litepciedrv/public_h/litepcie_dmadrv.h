...
#define DMA_WR_BUFFER_SIZE        (1024*1024)
#define DMA_RD_BUFFER_SIZE        (1024*2)
#define DMA_WR_BUFFER_TOTAL_SIZE (DMA_BUFFER_COUNT*DMA_WR_BUFFER_SIZE)
#define DMA_RD_BUFFER_TOTAL_SIZE (DMA_BUFFER_COUNT*DMA_RD_BUFFER_SIZE)
