...
stampinf -d %STAMPINF_DATE% -v %STAMPINF_VERSION% -x -f x64\Release\thunderscopedrv.inf
stampinf -d %STAMPINF_DATE% -v %STAMPINF_VERSION% -x -f x64\Release\litepciedrv\thunderscopedrv.inf
